...
export class UserDalLogger implements IBaseLogger {
...
export class UserContorllerRouterLogger implements IBaseLogger {
  logger: WinstonLogger;
  constructor() {
    this.logger = new WinstonLogger("UserContorllerRouter");
  }
